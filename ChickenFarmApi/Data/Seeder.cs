    ...
    public static class Seeder
    {
        public static void SeedData(ChickenFarmContext context)
        {
            ...
            var eggLayingRecords = new[]
            {
                ...
                new EggLayingRecord { Year = 2023, Month = 11, EggCount = 22, ChickenId = 1 },
                new EggLayingRecord { Year = 2023, Month = 10, EggCount = 19, ChickenId = 2 },
                new EggLayingRecord { Year = 2023, Month = 11, EggCount = 15, ChickenId = 2 },
                new EggLayingRecord { Year = 2023, Month = 10, EggCount = 23, ChickenId = 3 },
                new EggLayingRecord { Year = 2023, Month = 11, EggCount = 20, ChickenId = 3 },
                new EggLayingRecord { Year = 2023, Month = 10, EggCount = 25, ChickenId = 4 },
                new EggLayingRecord { Year = 2023, Month = 11, EggCount = 23, ChickenId = 4 },
                new EggLayingRecord { Year = 2023, Month = 10, EggCount = 28, ChickenId = 5 },
